            ...
            <div className={style.data_section}>
                <div className={style.data_item}>
                    ...
                    <div className={`${style.data_circle_overlay} ${style.red_overlay}`}>
                        <div className={`${style.data_circle} ${style.red}`}><strong>90</strong>BPM</div>
                    </div>
                </div>
                <div className={style.data_item}>
                    <Icon path={mdiStar} size={1} />
                    <p>Heart Score</p>
                    <div className={`${style.data_circle_overlay} ${style.center_overlay} ${style.yellow_overlay}`}>
                        <div className={`${style.data_circle} ${style.yellow} ${style.center}`}><strong>90</strong>/100</div>
                    </div>
                </div>
                <div className={style.data_item}>
                    ...
                    <div className={`${style.data_circle_overlay} ${style.green_overlay}`}>
                        <div className={`${style.data_circle} ${style.green}`}><strong>90</strong>ms</div>
                    </div>
                </div>
            </div>
            <p className={style.data_description}>Comment about heart comment about heart comment about heart</p>
